...
- Nastavení portu. Bud primo na RPi muzete spustit prikaz **ls -l /dev/serial/by-id/** nebo v Home Assistant v menu Supervisor > System > v okýnku Host jsou tři tečky a tam je Hardware.<br>
...
advanced:
  baudrate: 115200
  rtscts: false  #řízení toku vyžaduje jiný FW a nefunguje dobře na RPi
